...
class Functionality extends BaseModel {
    ...
    {
        return $this->hasMany('App\Models\FunctionalityRelation');
    }

    public function menus()
    {
        return $this->hasMany('App\Models\Menu', 'functionality_id');
    }
...
//        $oFunctionRelation = new FunctionalityRelation;
        ...
        $oQuery                            = app()->make('App\Models\FunctionalityRelation')->doOrderBy($oQuery);
    ...
    protected function beforeValidate() {
        $this->refresh_cycle    or $this->refresh_cycle    = 0;
        $this->search_config_id or $this->search_config_id = 0;
        $this->popup_id         or $this->popup_id         = 0;
