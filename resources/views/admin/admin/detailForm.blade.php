<div class="form-group">
    <label for="username" class="col-sm-3 control-label">*{{ ___('_adminuser.username') }}</label>
    <div class="col-sm-5">
...
@if (!$isEdit)
<div class="form-group">
    <label for="password"  class="col-sm-3 control-label">*{{ ___('_adminuser.password') }}</label>
...
<div class="form-group">
    <label for="password_confirmation"  class="col-sm-3 control-label">*{{ ___('_adminuser.password-confirm') }}</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="merchant_id" class="col-sm-3 control-label">{{ ___('_adminuser.merchant_id') }}</label>
    <div class="col-sm-5">
        <select class="form-control" name="merchant_id" id="merchant_id" >
            <option value="" ></option>
            @foreach ($aMerchantIds as $id => $title)
                <option value="{{ $id }}" {{ Input::old('merchant_id', isset($data) ? $data->merchant_id : '') == $id ? 'selected' : ''}}>{{ $title }}</option>
            @endforeach
        </select>
    </div>
</div>
...
<div class="form-group">
    <label for="menu_link" class="col-sm-3 control-label">{{ ___('_adminuser.menu_link') }}</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="menu_context" class="col-sm-3 control-label">{{ ___('_adminuser.menu_context') }}</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="actived" class="col-sm-3 control-label">{{ ___('_adminuser.actived') }}</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="secure_card_number" class="col-sm-3 control-label">{{ ___('_adminuser.secure_card_number') }}</label>
    <div class="col-sm-5">
