<div class="form-group">
    <label for="domain" class="col-sm-3 control-label">{{ ___('_domain.domain') }}</label>
    <div class="col-sm-5">
        <input type="text" class="form-control" id="domain" name="domain" value="{{ Input::old('domain', isset($data) ? $data->domain : '') }}"/>
    </div>
</div>
<div class="form-group">
    <label for="status" class="col-sm-3 control-label">{{ ___('_domain.status') }}</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="type[]" class="col-sm-3 control-label">{{ ___('_domain.type') }}</label>
    <div class="col-sm-5">
        <?php
