...
<div class="col-md-12">
    ...
    <div class="h3">{{ ___('Bind Rights For Role ' . $sRoleName) }}
...
@section('end')
    ...
    <?php
        ...
        foreach ($datas as $key => $value) {
            ...
            $item      = ['id' => $value[ 'id' ],'level' => $value[ 'level' ],'parent_id' => $value[ 'parent_id' ],'forefather_ids' => $value[ 'forefather_ids' ],'title' => $value[ 'title' ],'controller' => $value[ 'controller' ],'action' => $value[ 'action' ],'desc' => ___($sTitleKey,[],3)];
    if ($readonly) {
