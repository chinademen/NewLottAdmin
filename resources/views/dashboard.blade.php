@extends('l.base', array('active' => 'dashboard'))
{!! script('/js/echarts.common.min.js') !!}
@section('container')
	<div class="col-md-12" style="z-index: 100;">

		{{--<div class="jumbotron">
			<h3>{!! ___('_basic.welcome') !!}{!! ___('_basic.app-name') !!}</h3>
		</div>--}}
