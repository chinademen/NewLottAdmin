        ...
        <input id="download_flag" name="download_flag"  value="" type="hidden" />
            <table style="width:100%">
                ...
                <tr>
                    ...
                    <td >
                            <input class="form-control input-xs boot-time" type="text"  data-date-format="yyyy-mm-dd hh:ii" name="put_at[]"  value="{{@$aSearchFields['put_at'][0]}}">

                    </td>
                    <td class="text-right">至：</td>
                    <td >
                            <input class="form-control input-xs boot-time" type="text"  data-date-format="yyyy-mm-dd hh:ii" name="put_at[]"   value="{{@$aSearchFields['put_at'][1]}}">
