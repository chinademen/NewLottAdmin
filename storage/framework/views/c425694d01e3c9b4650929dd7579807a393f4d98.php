<?php $__env->startSection("title"); ?>
    <title><?php echo e(___('_main.title.reset_cash_password')); ?></title>
    ...
    <div class="mt30 content wrap1200">
        <div class="yb-breadcrumb">
            <div class="bc-wrap">
                ...
                <span><?php echo e(___('_reset_cash_password.cash_password')); ?></span>
            </div>
        </div>
        <div class="form mt10">
            <div class="ss-form pt30" style="padding-left: 314px">
                <div class="mb20">
                    <label style="width: 86px"><?php echo e(___('_reset_cash_password.old_password')); ?>：</label><input type="text"
                                                                                                           class="yb-input w400"
                                                                                                           placeholder="<?php echo e(___('_reset_password.pls_add_old_password')); ?>"
                                                                                                           id="old-password">
                </div>
                <div class="mb20">
                    <label style="width: 86px"><?php echo e(___('_reset_cash_password.new_password')); ?>：</label><input type="text"
                                                                                                           class="yb-input w400"
                                                                                                           placeholder="<?php echo e(___('_reset_password.pls_add_new_password')); ?>"
                                                                                                           id="password">
                </div>
                <div>
                    <label style="width: 86px"><?php echo e(___('_reset_cash_password.repeat_password')); ?>：</label><input
                            type="text" class="yb-input w400"
                            placeholder="<?php echo e(___('_reset_password.pls_repeat_new_password')); ?>"
                            id="password_confirmation">
                </div>
            </div>
            <div class="ss-btns">
                <a class="yb-btn" id="J_submit"><?php echo e(___('_reset_cash_password.confirm_edit')); ?></a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
    ...
    <script type="application/javascript">
        ...
        function ajaxData() {
            ...
            if (Password.length < 8 || Password.length > 16) {
                layer.tips("<?php echo e(___('_register.password_error1')); ?>", objRepeatPassword);
                return false;
            }
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo e(route('user-center.reset-cash-password')); ?>",
                dataType: "json",
                data: {
