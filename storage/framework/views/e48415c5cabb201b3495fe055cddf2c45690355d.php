...
<?php $__env->startSection("content"); ?>
    ...
    <div class="content wrap1200 mt30">
        ...
        <form action="<?php echo e(route('account-record.search')); ?>" method="get" id="search_form">

        <div class="orderManage mt10">
            <div class="om-search">
                <label class="font-c666 vm" >起止时间：</label>
                <span class="date vm">
                <input id="date0" type="text" class="yb-input w150" name="sStart" value="<?php echo e($sStart); ?>">
                <i id="date0_btn" class="iconfont icon-riqi"></i>
            </span>
                <span class="font-c666 vm">&nbsp;&nbsp;至&nbsp;&nbsp;</span>
                <span class="date vm">
                <input id="date1" type="text"  class="yb-input w150" name="sEnd" value="<?php echo e($sEnd); ?>">
                <i id="date1_btn" class="iconfont icon-riqi"></i>
            </span>
                <label class="font-c666 ml50 vm" >交易类型：</label>
                <span class="yb-select h34 vm">
                <i class="iconfont icon-xiala"></i>
                <input class="yb-input w120" readonly type="text" name="sTransactionType" value="<?php echo e($sTransactionType); ?>">
                <span class="options">
                    <span class="scroll">
                        <a href="javascript:"></a>
                ...
                <a href="javascript:;" onclick="document:search_form.submit()" class="yb-btn ml10 vm"><i class="icon iconfont icon-search"></i>搜索</a>
            </div>
        </form>
            <div class="tb-wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="opt green">
                            ...
                            if ($oUserOrder->buyer_id == Session::get('user_id')) {
                                echo '买进' . $oUserOrder->money_identifier;
                            } elseif ($oUserOrder->seller_id == Session::get('user_id')) {
                                echo '卖出' . $oUserOrder->money_identifier;
                            } else {
                                echo '';
                            }
                            ?>
                        ...
                        <td class="opt"><?php echo e($aStatus[$oUserOrder->status]); ?></td>
                        <td class="opt">
                            <a class="yb-btn blue" href="<?php echo e(route('account-record.view',['iId' => $oUserOrder->id])); ?>">查看详情</a>
                        </td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
