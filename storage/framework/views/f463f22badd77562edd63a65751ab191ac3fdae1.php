...
<html class="g-box">
<head>
    <title><?php echo e(env('APP_ENV') . __('_basic.app-title')); ?> </title>
...
<div class="g-box">
    <div class="g-l" id="menuContainer">
        <div class="logo" miniLogo='<?php echo e($aBaseInfo['mini-logo']); ?>' logo="<?php echo e($aBaseInfo['logo']); ?>"
             title="<?php echo e($aBaseInfo['app-title']); ?>">
            <?php echo e($aBaseInfo['logo']); ?>

        </div>
        <div class="side-menu" id="J-side-box">
            <?php $__currentLoopData = $aMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $aMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if (!isset($aMenu['children']) || !count($aMenu['children'])) continue; ?>
                <div class="side-li-box">
                    <div class="side-li-name">
                        <div class="li-name">
                            <i class="glyphicon glyphicon-book"></i>
                            <font><?php echo e(___('_function.' . $aMenu['title'])); ?> </font>
                        </div>
                    </div>

                    <div class="side-box">
                        <?php $__currentLoopData = $aMenu['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aSubMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <div class="side-li">
                                <a target="<?php echo e($sTarget); ?>"
                                   href="<?php echo e($sUrl); ?>"><?php echo e(___( '_function.' . $aSubMenu['title'])); ?></a>
                            </div>
    ...
    <div class="g-c">
        <div class="heard-top" id="headerContainer">
            ...
            <div class="pull-right">
                ...
                <a target="main" href="<?=route('admin-users.change-password')?>"
                   class="btn btn-link"><?php echo e($aLoginUser['username']); ?></a>
                <span class="exit-box">
                            <a target="_parent" href="/auth/logout" title="<?php echo e(___('_basic.logout')); ?>"
                               class="btn btn-link">
        ...
        <iframe name="main" id="contentContainer" src="<?php echo e($sMainUrl); ?>" style="border:0;"></iframe>
    </div>
</div>
